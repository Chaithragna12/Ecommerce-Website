       ...
       <Link to='/'> <img src={assets.logo} className='w-36' alt="" /></Link>
        ...
        <div className='flex items-center gap-6'>
          ...
          <div className='group relative'>
            <img onClick={()=>token?null:navigate('/login')} src={assets.profile} className='w-8 cursor-pointer' alt="" />
            {/* dropdown */}
            {token && 
          ...
          <p className='absolute right-[-5px] bottom-[-1px] w-4 text-center leading-4 bg-black text-white aspect-square rounded-full text-[8px]'>{getCartCount()}</p>
